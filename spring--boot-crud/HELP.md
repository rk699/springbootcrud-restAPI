...
* The original package name 'com.purusottam.spring-boot-crud' is invalid and this project uses 'com.purusottam.springbootcrud' instead.
...
```
$ docker run --rm -p 8080:8080 spring--boot-crud:0.0.1-SNAPSHOT
```
